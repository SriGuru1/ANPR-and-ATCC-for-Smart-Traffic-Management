...
class AccidentDetection:
    ...
    # ✅ Properly indented static method
    @staticmethod
    def detect_accident(video_paths):
        """Static method to initialize and run accident detection."""

        # Automatically find model path in current directory
        MODEL_PATH = os.path.join(os.getcwd(), "accident_best.pt")
...
if __name__ == "__main__":
    AccidentDetection.detect_accident([
        r"C:\Users\Admin\ANPR-and-ATCC-for-Smart-Traffic-Management\sample detection videos\accident.mp4",
        r"C:\Users\Admin\ANPR-and-ATCC-for-Smart-Traffic-Management\sample detection videos\triple riding 2.mp4"
    ])
